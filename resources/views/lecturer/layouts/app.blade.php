        ...
        <div class="flex flex-col h-full">
            ...
            <div class="flex items-center justify-between p-4 border-b">
                <div class="flex items-center">
                    ...
                    <span class="text-xl font-bold text-purple-600">Lecturer Portal</span>
                </div>
            ...
            <nav class="flex-1 overflow-y-auto py-4">
                ...
                <div class="px-4 space-y-1">
                    <a href="{{ route('lecturer.dashboard') }}"
                       class="flex items-center px-3 py-2 text-sm font-medium rounded-md {{ request()->routeIs('lecturer.dashboard') ? 'bg-purple-100 text-purple-700' : 'text-gray-700 hover:bg-purple-50 hover:text-purple-600' }}">
                        <i class="fas fa-tachometer-alt w-5 mr-3"></i>
                        Dashboard
                    </a>

                    <!-- My Courses Dropdown -->
                    <div x-data="{ open: {{ request()->routeIs('lecturer.courses.*') ? 'true' : 'false' }} }">
                        <button @click="open = !open"
                                class="w-full flex items-center justify-between px-3 py-2 text-sm font-medium rounded-md {{ request()->routeIs('lecturer.courses.*') ? 'bg-purple-100 text-purple-700' : 'text-gray-700 hover:bg-purple-50 hover:text-purple-600' }}">
                            <div class="flex items-center">
                        ...
                        <div x-show="open" class="mt-1 ml-8 space-y-1">
                            <a href="#"
                               class="flex items-center px-3 py-2 text-sm font-medium rounded-md {{ request()->routeIs('lecturer.courses.active*') ? 'bg-purple-100 text-purple-700' : 'text-gray-700 hover:bg-purple-50 hover:text-purple-600' }}">
                                <i class="fas fa-play-circle w-4 mr-3"></i>
                                Active Courses
                            </a>
                            <a href="#"
                               class="flex items-center px-3 py-2 text-sm font-medium rounded-md {{ request()->routeIs('lecturer.courses.archived*') ? 'bg-purple-100 text-purple-700' : 'text-gray-700 hover:bg-purple-50 hover:text-purple-600' }}">
                    ...
                    <a href="#"
                       class="flex items-center px-3 py-2 text-sm font-medium rounded-md {{ request()->routeIs('lecturer.grading*') ? 'bg-purple-100 text-purple-700' : 'text-gray-700 hover:bg-purple-50 hover:text-purple-600' }}">
                        <i class="fas fa-clipboard-check w-5 mr-3"></i>
                        Grading
                    </a>

                    <a href="#"
                       class="flex items-center px-3 py-2 text-sm font-medium rounded-md {{ request()->routeIs('lecturer.schedule*') ? 'bg-purple-100 text-purple-700' : 'text-gray-700 hover:bg-purple-50 hover:text-purple-600' }}">
                        <i class="fas fa-calendar-alt w-5 mr-3"></i>
                        Schedule
                    </a>

                    <a href="#"
                       class="flex items-center px-3 py-2 text-sm font-medium rounded-md {{ request()->routeIs('lecturer.students*') ? 'bg-purple-100 text-purple-700' : 'text-gray-700 hover:bg-purple-50 hover:text-purple-600' }}">
                        <i class="fas fa-users w-5 mr-3"></i>
                        Students
                    </a>

                    <a href="#"
                       class="flex items-center px-3 py-2 text-sm font-medium rounded-md {{ request()->routeIs('lecturer.materials*') ? 'bg-purple-100 text-purple-700' : 'text-gray-700 hover:bg-purple-50 hover:text-purple-600' }}">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-purple-100 mt-1">
                            ...
                            {{ auth()->guard('lecturer')->user()->department ?? 'Department' }} • NIP: {{ auth()->guard('lecturer')->user()->nip }}
                        </p>
                    </div>
