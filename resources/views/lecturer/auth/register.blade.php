...
@section('title', 'Lecturer Register')
...
<div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
        ...
        <form class="mt-8 space-y-6" action="{{ route('lecturer.register') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="space-y-4">
                <!-- Profile Photo Upload -->
                <div class="flex flex-col items-center">
                    <div class="mb-4">
                        <div class="w-32 h-32 rounded-full overflow-hidden border-4 border-purple-500 bg-gray-200 flex items-center justify-center">
                ...
                <div>
                    <label for="nip" class="block text-sm font-medium text-gray-700 mb-1">NIP (Lecturer ID)</label>
                    <input id="nip" name="nip" type="text" required 
                           class="appearance-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-purple-500 focus:border-purple-500 focus:z-10 sm:text-sm"
                           placeholder="NIP (Lecturer ID)" value="{{ old('nip') }}">
                </div>
            ...
            <div class="text-center">
                <a href="{{ route('lecturer.login') }}" class="font-medium text-purple-600 hover:text-purple-500">
